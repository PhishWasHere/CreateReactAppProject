...
export default function Home() {
  ...
  return (
    ...
    <button onClick={handleClick} className={projects.length === 0 ? 'hidden' : 'flex flex-wrap p-2 rounded-md transition-all mx-6 mb-3 btn-primary' }>➕</button>
          ...
          {loading ? (
            <div>Loading...</div>
              ...
              <section className='flex justify-center'>
                <div className=''>
                  <h2 className='bg-primary text-black text-lg p-2 rounded-md text-center'>No Projects Yet</h2>
                  <AddProject />
                </div>
              </section>
          ) : (
