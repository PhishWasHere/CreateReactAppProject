...
export default function ProjectDelete () {
    ...
    const handleDelete = async (e) => { 
        ...
        try {
            ...
            navigate (0); //forces a refresh of the page
        } catch (err) {
            console.log(err);
        }
    };
                ...
                <div className="p-4 w-full max-w-md h-full md:h-auto">
                    <div className="relative p-4 text-center bg-base-100 border border-base-200 rounded-lg shadow sm:p-5">
                        ...
                        <div className="flex justify-center items-center space-x-4">
                            ...
                            <button type="submit" onClick={(e) => handleDelete(e)} className="py-2 px-3 text-sm font-medium text-center rounded-lg btn-error text-gray-900 focus:ring-4 focus:outline-none ">
                                Yes, I'm sure
                            </button>
                        </div>
                    </div>
